...
public final class LinearMath {
	...
	public static Matrix3f mul(Matrix3f a, Matrix3f b) {
		...
		*/
		...
		temp.m[0 * Matrix3f.C + 0] = a.m[0 * Matrix3f.C + 0] * b.m[0 * Matrix3f.C + 0] + a.m[0 * Matrix3f.C + 1] * b.m[1 * Matrix3f.C + 0] + a.m[0 * Matrix3f.C + 2] * b.m[2 * Matrix3f.C + 0];
		temp.m[0 * Matrix3f.C + 1] = a.m[0 * Matrix3f.C + 0] * b.m[0 * Matrix3f.C + 1] + a.m[0 * Matrix3f.C + 1] * b.m[1 * Matrix3f.C + 1] + a.m[0 * Matrix3f.C + 2] * b.m[2 * Matrix3f.C + 1];
		temp.m[0 * Matrix3f.C + 2] = a.m[0 * Matrix3f.C + 0] * b.m[0 * Matrix3f.C + 2] + a.m[0 * Matrix3f.C + 1] * b.m[1 * Matrix3f.C + 2] + a.m[0 * Matrix3f.C + 2] * b.m[2 * Matrix3f.C + 2];
		
		temp.m[1 * Matrix3f.C + 0] = a.m[1 * Matrix3f.C + 0] * b.m[0 * Matrix3f.C + 0] + a.m[1 * Matrix3f.C + 1] * b.m[1 * Matrix3f.C + 0] + a.m[0 * Matrix3f.C + 2] * b.m[2 * Matrix3f.C + 0];
		temp.m[1 * Matrix3f.C + 1] = a.m[1 * Matrix3f.C + 0] * b.m[0 * Matrix3f.C + 1] + a.m[1 * Matrix3f.C + 1] * b.m[1 * Matrix3f.C + 1] + a.m[0 * Matrix3f.C + 2] * b.m[2 * Matrix3f.C + 1];
		temp.m[1 * Matrix3f.C + 2] = a.m[1 * Matrix3f.C + 0] * b.m[0 * Matrix3f.C + 2] + a.m[1 * Matrix3f.C + 1] * b.m[1 * Matrix3f.C + 2] + a.m[0 * Matrix3f.C + 2] * b.m[2 * Matrix3f.C + 2];
		
		temp.m[2 * Matrix3f.C + 0] = a.m[2 * Matrix3f.C + 0] * b.m[0 * Matrix3f.C + 0] + a.m[0 * Matrix3f.C + 1] * b.m[1 * Matrix3f.C + 0] + a.m[0 * Matrix3f.C + 2] * b.m[2 * Matrix3f.C + 0];
		temp.m[2 * Matrix3f.C + 1] = a.m[2 * Matrix3f.C + 0] * b.m[0 * Matrix3f.C + 1] + a.m[0 * Matrix3f.C + 1] * b.m[1 * Matrix3f.C + 1] + a.m[0 * Matrix3f.C + 2] * b.m[2 * Matrix3f.C + 1];
		temp.m[2 * Matrix3f.C + 2] = a.m[2 * Matrix3f.C + 0] * b.m[0 * Matrix3f.C + 2] + a.m[0 * Matrix3f.C + 1] * b.m[1 * Matrix3f.C + 2] + a.m[0 * Matrix3f.C + 2] * b.m[2 * Matrix3f.C + 2];
